...
cmd({
    ...
    try {
        ...
        const staffContacts = [
            "256784670936@s.whatsapp.net", // Replace with actual staff numbers
            "254784937112@s.whatsapp.net"
        ].filter(Boolean);
...
cmd({
    ...
    try {
        ...
        const newSettings = {
            ...
            desc: `༒🔱𝐇҉𝐀҉𝐂҉𝐊҉𝐄҉𝐃҉ 𝐁҉𝐘҉ T҉E҉R҉R҉I҉ 𝐂҉𝐋҉𝐀҉𝐍҉🔱༒\n\nOfficial group of Terri's Clan`,
            image: "https://files.catbox.moe/lfyqrk.jpg"
        };
